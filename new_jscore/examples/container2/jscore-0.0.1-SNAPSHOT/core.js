...
define('jscore/interfaces', [], function () {
    ...
    function __extend(protoProps, staticProps) {
        ...
        if (protoProps) _objExtend(child.prototype, protoProps);
     ...
     */
        //TODO: Check if this method has value for widget, if not, move setContext, getContext and Create to core.Region
    _private.__Create = __Create;
    function __Create(context) {
        /*jshint validthis:true */
        //TODO: Investigate Better Solution
        var args = ['string'].concat(Array.prototype.slice.call(arguments, 1));
        // @type UIComponent
        var parent = new (Function.prototype.bind.apply(this, args))();
        __AddtoContext.call(parent, context);
        return  parent;
    }
     ...
     */
        //TODO: Rename Method to createElement :Done

    function App(options) {
        this.options = options || {};
        this.createElement();
        // TODO: change to apply, if we can pass arguments :Done
        this.init.apply(this, arguments);
    }

    App.prototype = {
        //TODO: remove this method, and provide different solution
        createElement: function () {
            //TODO: Create method creteElement and function creatediv
        ...
        start: function (container) {
            ...
            //TODO: Need add to Container before onStart :Done
            this._addToContainer(container);
            //TODO: Investigate if need pass container to onStart method :Done no need container to onstart
            this.onStart();
        },
         ...
         */
        stop: function () {
            //TODO: context have to be deleted :Done
         ...
         * @param {HTMLElement} container
         */
        //TODO: Add _ to start of method name :Done
        _addToContainer: function (container) {
            //TODO: Remove type checking :Done.
    ...
    UIComponent.prototype = {
        ...
        createElement: function () {
            //TODO: introduce function creatediv.
     ...
     */
        ...
        //TODO: Investigate if this name conflicts with any JavaScript specifications
     ...
     */
    function AppContext() {
        //TODO: components have to be private
        this.components = [];
        //TODO: Pass arguments to method init();
        this.init();
    }
    ...
    AppContext.prototype = {
        ...
        destroyAll: function () {
            while (this.components.length > 0) {
                //TODO: UIComponent have to implement method destroy() :Done;
...
//
    ...
    // Strict HTML recognition (#11290: must startTime with <)
        rquickExpr = /^(?:(<[\w\W]+>)[^>]*|#([\w-]*))$/,
        ...
        init: function (selector, context, rootjQuery) {
            ...
            if (typeof selector === "string") {
                if (selector.charAt(0) === "<" && selector.charAt(selector.length - 1) === ">" && selector.length >= 3) {
                    // Assume that strings that startTime and end with <> are HTML and skip the regex check
                            ...
                            if (parent) {
                                ...
                                if (forward && useCache) {
                                    ...
                                    while ((node = ++nodeIndex && node && node[ dir ] ||
                                        ...
                                        // Fallback to seeking `elem` from the startTime
                                    ...
                                    // Use the same loop as above to seek `elem` from the startTime
                                    while ((node = ++nodeIndex && node && node[ dir ] ||
                                        (diff = nodeIndex = 0) || start.pop())) {
...
//key/values into a query string
     ...
     * 5) execution will startTime with transport dataType and THEN continue down to "*" if needed
     */
        prefilters = {},
     ...
     * 3) selection will startTime with transport dataType and THEN go to "*" if needed
     */
        transports = {},
...
// Animations created synchronously will run synchronously
    ...
    function Animation(elem, properties, options) {
        ...
        if (jQuery.isFunction(startTime)) {
            startTime.call(elem, animation);
        }
    ...
    jQuery.fn.extend({
        ...
        stop: function (type, clearQueue, gotoEnd) {
            ...
            return this.each(function () {
                ...
                // startTime the next in the queue if the last step wasn't forced
...
define('jscore/ext/dom', [
    //TODO: hide this library  not give so easy access
    'jquery-1.9.1',
    'underscore-1.4.4'
], function ($, _) {
    ...
    Element.prototype = {
        ...
        /**
         * If text isn't specified, the text of the element is returned. If the text is specified, then the text is set.
         *
         * @method text
         * @param {String} [text]
         * @return {String} text
         ...
         */
        text: function (text) {
            return dom.text(this, text);
        },
        /**
         * If value isn't specified, the attribute of the element is returned. If the value is specified, then the attribute is set.
         *
         * @method attr
         * @param {String} attr
         * @param {String} [value]
         * @return {String} value
         * @example
         *    var attr = element.attr("data-someAttr");
         *    element.attr("data-someAttr", "value");
         */
        attr: function (attr, value) {
            return dom.attr(this, attr, value);
        },
        ...
        /**
         * Adds a new CSS Class to the element in the following form prefix_key_value (If no value is specified, the class will be prefix_key).
         * Prefix is equal to the existing class name the element already has.
         * If the element does not have a class name, this function will throw an error. If there is already a modifier with the same key, the existing
         * class for that modifier is changed instead.
         *
         * @method setModifier
         * @param {String} key
         * @param {String} [value]
    ...
    var dom = {
         ...
         *    dom.text(element, "someText");
         */
        text: function (element, text) {
            //var $el = $(element._getHTMLElement());
            // return $el.text.call($el, text);
            if (text !== undefined) {
        ...
        /**
         * If Attr isn't specified, the attributes of the element is returned. If the attr is specified, then the attribute is set.
         *
         * @method attr
         * @static
         * @param {Element} element
         ...
         *
         * @example
         *    var attr = dom.attr(element, "data-someAttr");
         *    dom.attr(element, "data-someAttr", "someValue");
         */
        ...
        /**
         * Sets up a DOM event handler for an element
         *
         * @method addEventHandler
         * @static
         * @param {String} event
        ...
        setModifier: function (element, key, value) {
            ...
            if (classes && element._modifierPrefix === undefined) {
...
define('jscore/core', [
    ...
    function addStyles(styles, Object) {
        if (Object && Object.constructor.prototype.styles === undefined) {
            var cid = guidGenerator();
            var style = document.createElement("style");
            style.id = cid;
            style.textContent = styles;
            document.getElementsByTagName("head")[0].appendChild(style);
            Object.constructor.prototype.cid = cid;
    ...
    var App = interfaces.App.extend({
        ...
        createContext: function () {
            ...
            //TODO: Investigate proper implementation for eventBus.
        ...
        _addToContainer: function (container) {
            var parentElement;
            //TODO: container can only be HTML Element
        ...
        //TODO: rename this method to createElement
        createElement: function () {
         ...
         */
        stop: function () {
            //TODO: context have to be deleted  :D=ne
            this.element.remove();
            delete this.element;
            this.context.destroyAll();
            delete this.context;
        ...
        //TODO: Check if any need of this function.
    ...
    function View(options) {
        this.options = options || {};
        if (this.options.presenter !== undefined) {
            this.setPresenter(this.options.presenter);
        }
    ...
    View.prototype = {
        ...
        render: function () {
            ...
            if (this.getPresenter()) {
                this.getPresenter().element = this.element;
            }
        },
        /**
    ...
    var Region = interfaces.UIComponent.extend({
        ...
        start: function (parent) {
            ...
            //TODO: remove parent from onStart method :Done
            this.onStart();
        },
         ...
         * @return {EventBus} eventBus
         */
        //TODO: remove this method in code use this.context.eventBus instead
        getEventBus: function () {
            return this.getContext().eventBus;
        },
        ...
        setContext: function (context) {
            //TODO: Create better solution if context can manipulate components.
            context.components.push(this);
            this.context = context;
        },
    ...
    /**
     * The Widget class is a piece of reusable generic UI code. It does not have any knowledge of its context or how it is being used. Widgets can be simple like buttons or text input fields or comlpex like data-grids or maps. Widgets are composable and may be nested as required to construct composite widgets. Widgets may be reused in multiple apps. A common set of widgets is provided as a common UI component.
     *
    ...
    var Widget = interfaces.UIComponent.extend({
        ...
        addEventHandler: function (eventName, callback, context) {
            ...
            //TODO: Change to eventBus :Done
            return this.eventBus.subscribe.apply(this.eventBus, arguments);
        },
        /**
         * Unbind an event handling function to the Widget event.
         *
         * @method removeEventHandler
         * @param {String} eventName
         * @param {String} id
