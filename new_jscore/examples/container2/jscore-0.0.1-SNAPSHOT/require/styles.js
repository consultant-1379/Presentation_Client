                ...
                if (this.selectors) {
                    for (var i = 0; i < this.selectors.length; i++) {
                        if (this.selectors[i].extend) {
                            this.selectors[i].extend.eval(env, [
                                [this.selectors[i]]
                            ].concat(env.selectors.slice(1)));
                        }
                    }
                }
...
define('styles',['require', 'exports', 'module', 'less-1.4.0'], function (require, exports, module) {
    'use strict';
