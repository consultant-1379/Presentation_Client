...
define('jscore/ext/mvp',[
    ...
    var View = core.View.extend({
         ...
         * @example
         *    events: {
		 *		"click .myClass": "presenterFunction",
		 *		"dblclick .myOtherClass" : "otherPresenterFunction"
		 *	}
         */
        events: {},
        ...
        /**
         * Goes through the events object, and creates event listeners using the selector defined, and uses the functions in the parent presenter.
         *
        ...
        delegateEvents: function (events) {
            ...
            for (var key in events) {
                ...
                if (!method) {
                    throw new Error("Function " + events[key] + " not found in parent");
                }
...
//				for (var i = 0; i < el.length; i++) {
                var eventId = el.addEventHandler(eventName, method, parent);
...
//				}
        ...
        /**
         * Wipes all event handlers created by delegateEvents
         *
    ...
    /**
     * The Model is the client side data store. It may store data originated in the client or on the server and facilitates pushing data changes to the server.
     *
     * @class ext.mvp.Model
     */
    function Model(attributes, options) {

        var settings = _.extend({model: this.Model, _collection: this}, options || {});
        ...
        if (attributes instanceof Model) {
            ...
            // TODO: We should check what we pass to Backbone methods
        ...
        //TODO: Add methods to Model, if we can pass our own Model to backbone Collectiom
        //TODO: Methods are id, cid, trigger, attributes, get, save, constructor,  _validate, off, idAttribute
    ...
    Model.prototype = {
         ...
         */
        //TODO: Can we change this method to get instead of getAttribute, reason, we need to inject our model to Collection
        getAttribute: function (attribute) {

            // TODO: Should we check the arguments?
            // TODO: Use shortcode: model.get.apply(model, ...
            var model = this._model;
            return model.get.apply(model, arguments);
         ...
         */
        //TODO: Can we change this method to set instead of setAttributes, reason, we need to inject our model to Collection
        ...
        /**
         * Sends a delete HTTP request to the server for the model
         *
         * @method destroy
         */
        destroy: function (options) {
        ...
        removeEventHandler: function (eventName, eventId) {
            ...
            args[0] = eventName;
            var model = this._model;
            // TODO: Check if callback contains Backbone event/model
    ...
    Collection.prototype = {
        ...
        getModel: function (id) {
            ...
            /*     if (model) {
             ...
             model._model = new this.Model();
             model._model._model = model;
             model._model.cid = model.cid;
             model.urlRoot = model._model.url;
             return model._model;
             }
             } */
            return model;
        ...
        setModels: function (models, options) {
            var collection = this._collection;
            //TODO: Looks like this method not needed. Check in Backbone source code
//            models = (!_.isArray(models)) ? [models] : models;
        ...
        /**
         * Updates the Collection with the current server side resource state.
         *
         * @method fetch
         * @param {Object} [options]
         */
