...
define('template', ['require', 'exports', 'module', 'jscore/handlebars/handlebars'], function (require, exports, module) {
    'use strict';
    var progIds = ['Msxml2.XMLHTTP', 'Microsoft.XMLHTTP', 'Msxml2.XMLHTTP.4.0'],
        ...
        fs,
        Handlebars,
        handlebars = 'jscore/handlebars/handlebars';
        ...
        write: function (pluginName, moduleName, write, config) {
            if (buildMap.hasOwnProperty(moduleName)) {
                ...
                write.asModule(pluginName + "!" + moduleName,
                    "define(['"+handlebars+"'],function (Handlebars) { return Handlebars.template(" +
                        content +
                        ");});\n");
            }
        },
    ...
    if (typeof process !== "undefined" && process.versions && !!process.versions.node) {
        ...
        fs = nodeRequire('fs');
        Handlebars = nodeRequire('handlebars');
